...
hot_phrases = [("Each", "each"), ("Brighter", "bitter"), ("Mob", "mab"), ("Pony", "screw"),
               ("Glimpea", "Shell"), ("Both", "Every"), ("Running", "Breeze"), ("Lamppost", "Shade"),
               ("Stairs", "Overcasting"), ("Reflection", "Smooth"), ("Tower", "Boat"), ("Supra", "Inferior"),

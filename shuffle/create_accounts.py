...
covert_messages = replace_msg_dates(messages=covert_messages, dates=[datetime(2012, 6, 18), datetime(2012, 7, 15), datetime(2012, 8, 16)], ratio=0.6)
overt_messages = replace_msg_dates(messages=overt_messages, dates=[datetime(2012, 6, 18), datetime(2012, 7, 15), datetime(2012, 8, 16)], ratio=0.6)
